...
public class GestionUsuariosService {
    ...
    public ResultadoOperacion crearUsuario(Usuario usuario, String nombreRol) {
        try {
            ...
            try {
                ...
                // 2.1 Validar rol
                Optional<Rol> rolOpt = repositorioRol.buscarPorNombreRol(nombreRol.toLowerCase());
                if (rolOpt.isEmpty()) {
                ...
                repositorioTokenUsuario.guardar(tokenUsuario);
                ...
                switch (tipoUsuario) {
                    case "Profesor":
                        ...
                        profesor.setTokenAccess(tokenUsuario);
                    ...
                    case "Directivo":
                        ...
                        directivo.setTokenAccess(tokenUsuario);
                        repositorioUsuario.guardar(directivo);
                        usuario = directivo;
                        usuario.setIdUsuario(directivo.getIdUsuario());
                        break;
                }
    ...
    public ResultadoOperacion consultarUsuario(Integer usuarioId) {
        try {
            ...
            Optional<Usuario> usuarioOpt = repositorioUsuario.buscarPorId(usuarioId);
