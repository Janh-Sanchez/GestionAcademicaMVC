...
import com.servicios.GestionAspirantesService;
import com.servicios.GestionAspirantesService.AspiranteDTO;
import com.servicios.GestionAspirantesService.EstudianteDTO;
import com.servicios.GestionAspirantesService.ResultadoOperacion;
...
public class ListaAspirantesPanel extends JFrame {
    ...
    private GestionAspirantesService gestionService;
    private JPanel panelContenido;
    private JScrollPane scrollPane;
    
    public ListaAspirantesPanel() {
        this.gestionService = new GestionAspirantesService(JPAUtil.getEntityManagerFactory().createEntityManager());
    ...
    private void cargarAspirantes() {
        ...
        ResultadoOperacion resultado = gestionService.obtenerListaAspirantes();
        ...
        List<AspiranteDTO> aspirantes = (List<AspiranteDTO>) resultado.getDato();
    ...
    private void aprobarEstudiante(EstudianteDTO estudiante) {
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            ResultadoOperacion resultado = gestionService.aprobarEstudiante(estudiante.getIdEstudiante());
    ...
    private void rechazarEstudiante(EstudianteDTO estudiante) {
        ...
        if (confirmacion == JOptionPane.YES_OPTION) {
            ResultadoOperacion resultado = gestionService.rechazarEstudiante(estudiante.getIdEstudiante());
    ...
    private void mostrarListaVacia() {
        ...
        JLabel lblMensaje = new JLabel("<html><center>En este momento no hay registros de<br>preinscripciones, vuelva más tarde</center></html>");
