...
/**
 * Panel para que el directivo consulte un grupo específico
 */
public class ConsultarGrupoDirectivoPanel extends JFrame {
    ...
    public ConsultarGrupoDirectivoPanel(Integer idGrupo) {
    ...
    private void inicializarComponentes() {
        setTitle("Consultar Grupo - Sistema de Gestión Académica");
    ...
    private JPanel crearPanelInformacion() {
        ...
        // Título
        JLabel lblTitulo = new JLabel("INFORMACIÓN DEL GRUPO", SwingConstants.CENTER);
        ...
        lblNombreProfesor = new JLabel("Profesor: Cargando...");
        lblNombreProfesor.setFont(new Font("Arial", Font.PLAIN, 12));
        lblNombreProfesor.setForeground(CT);
        lblNombreProfesor.setAlignmentX(Component.CENTER_ALIGNMENT);
        panel.add(lblNombreProfesor);
    ...
    private void cargarDatosGrupo() {
        ResultadoOperacion resultado = controller.obtenerGrupoPorId(idGrupo);
        ...
        lblNombreProfesor.setText("Profesor: " + datosGrupo.getNombreProfesor());
